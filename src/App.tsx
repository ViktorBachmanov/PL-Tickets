    ...
    <div className="App">
      <Routes>
        ...
        <Route path={RoutesPathes.ROOT} element={<Layout />}>
          <Route
            index
            element={<Navigate to={RoutesPathes.DASHBOARD} replace={true} />}
          />
          <Route path={RoutesPathes.DASHBOARD} element={<Dashboard />} />
          <Route path={RoutesPathes.TICKETS} element={<Tickets />} />
          <Route
            path={RoutesPathes.TICKET_ID}
            element={<TicketForm mode={Mode.READ} />}
          />
          <Route
            path={RoutesPathes.CREATE}
            element={<TicketForm mode={Mode.NEW} />}
          />
        </Route>
      </Routes>
    </div>
